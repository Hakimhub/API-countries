...
var flag = document.querySelector("#flag-container img");
...
// array used to stock my global object
var arrayGlobal = [];



function ajaxGet(url, callback) {
  //This is how to use XMLHttpRequest to issue HTTP requests in
  // order to exchange data between the web site and a server.
...
function selectChange() {
  ...
  timezone.textContent=found.timezones;
  languages.textContent=found.languages[0].name;
  alpha2Code.textContent=found.alpha2Code; 
  // Flag image
